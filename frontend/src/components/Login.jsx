  ...
  return (
    <div className='fixed top-0 left-0 right-0 bottom-0 z-10 backdrop-blur-sm bg-black/30 flex justify-center items-center'>
        ...
        >
            ...
            <p className='text-sm text-center mt-2'>Welcome Back! Please {state} to continue</p>
            ...
            <div className='border px-6 py-2 flex items-center gap-2 rounded-full mt-4'>
                ...
                <input type='email' placeholder='Email Address' required className='outline-none text-sm' onChange={e => setEmail(e.target.value)} value={email}/>
            </div>
